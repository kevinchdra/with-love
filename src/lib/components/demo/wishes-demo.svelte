<script lang="ts">
  ...
  const demoWishes = [
    {
      full_name: "John & Sarah",
      wishes: "Wishing you both a lifetime of love and happiness! ❤️",
      submitted_at: "2025-07-30T08:00:00Z"
    },
    {
      full_name: "Michael Chang",
      wishes: "Congratulations on your special day! May your love story continue to inspire others.",
      submitted_at: "2025-07-29T15:30:00Z"
    },
    {
      full_name: "Emma & David",
      wishes: "Here's to a beautiful beginning of your forever. Best wishes!",
      submitted_at: "2025-07-28T12:45:00Z"
    }
  ];

  onMount(() => {
    wishesWall = demoWishes;
    loading = false;
  });
